-- =====================================================
-- admin_adjust_user_balance — recreate with fixed NaN check
-- Replaces isnan()/isinf() (PG14+ numeric overloads, missing on live DB)
-- with p_amount = 'NaN'::numeric. isinf dropped (numeric has no Infinity).
-- Everything else identical to migration 026.
-- =====================================================
